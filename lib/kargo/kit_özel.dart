          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                reusableTextField_1('', Icons.search),
                SizedBox(
                  height: 70,
                ),
                kit_button1(context, 'Sağlık Kitleri'),
                SizedBox(
                  height: 25,
                ),
                kit_button1(context, 'Yardım Kitleri'),
                SizedBox(
                  height: 25,
                ),
                kit_button1(context, 'ABC Kitleri'),
                SizedBox(
                  height: 25,
                ),
                kit_button1(context, 'CDE Kitleri'),
                SizedBox(
                  height: 25,
                ),
                kit_button1(context, 'FGE Kitleri')
